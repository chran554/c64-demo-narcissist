...
.var picture = LoadBinary("koala/christian.kla", KOALA_TEMPLATE)
...
!:
        dex
        sta screen_memory_address + constant_columns_per_line * (constant_static_text_line_index - 2), x
        sta screen_memory_address + constant_columns_per_line * (constant_static_text_line_index - 1), x
        sta screen_memory_address + constant_columns_per_line * constant_static_text_line_index, x
        bne !-
...
invertFont:
        ...
        ldx #$00
!:
        lda address_font + i, x
        eor #%11111111
        sta address_font + i, x
...
scroll_message_text:
    .encoding "screencode_mixed"
    .text @"this is a test text of a scroll message! "
    .text @" but rather a mimics the looks and operation of a 8*40 led matrix panel that you can see"
    .text @" in the window of your favourite pizza place."
    .byte $00 // Scroll message text is null terminated
#endif
...
//    .import c64 "fonts/giana_sisters.font.64c"
//    .import c64 "fonts/devils_collection_25_y.64c"
    .import binary "fonts/double_char_font.bin"
#endif
